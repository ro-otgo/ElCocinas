...
INGREDIENTS_TXT_FILE = r'ETL\Codigo\ingredients\dataset_ingredients\representation-for-ingredients\train.txt'
OUTPUT_DIR = r'ETL\Datos\ingredients\processed\spacy'
