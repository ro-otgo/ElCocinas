...
Este script esta disenado para textos en espanol.
...
TRANSCRIPT_DIR = 'output_transcripciones'
        ...
        for file_name in filenames:
            if file_name.endswith('.json'):
                with open(os.path.join(dirpath,file_name), 'r') as file:
                    ...
                    text_video = ' '.join(map(lambda x: limpiar_text(x.get('text')), file_content))
